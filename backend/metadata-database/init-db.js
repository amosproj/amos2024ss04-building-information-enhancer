...
const datasets = [
  {
    metadataBasicData: {
      ...
      Name: "Empty Map",
      ShortDescription:
        "An empty, default map of Germany, with no data loaded.",
    },
    metadataAdditionalData: {
      Type: "none",
      LongDescription:
        "An empty, default map of Germany, with no data loaded. Useful for exploring the map.",
      MinZoomLevel: -1,
      MarkersThreshold: -1,
      DisplayProperty: "",
      Tables: [],
  ...
  },
  {
    ...
    metadataAdditionalData: {
      ...
      Type: "marker",
      LongDescription:
        "A map of EV charging stations displays the locations of electric vehicle charging points located in Germany, helping drivers plan routes and manage charging needs. It is essential for supporting the adoption and convenience of electric vehicles.",
      MinZoomLevel: 10,
      MarkersThreshold: -1,
